...
class LoadingDotsPrimary extends StatefulWidget {
  final double fem;

  LoadingDotsPrimary({required this.fem});

  @override
  _LoadingDotsPrimaryState createState() => _LoadingDotsPrimaryState();
}

class _LoadingDotsPrimaryState extends State<LoadingDotsPrimary>
